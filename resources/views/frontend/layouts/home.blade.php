...
<main class="main">
  ...
  <div class="portfolio-content h-100">
    ...
    <div class="portfolio-info">
      ...
      <a href="{{ asset('Frontend/assets/img/portfolio/app-1.jpg') }}" 
         title="App 1" 
  ...
  <div class="portfolio-content h-100">
    ...
    <div class="portfolio-info">
      <h4>App 2</h4>
      <p>Lorem ipsum, dolor sit amet consectetur</p>
      <a href="{{ asset('Frontend/assets/img/portfolio/app-2.jpg') }}" 
         title="App 1" 
         data-gallery="portfolio-gallery-app" 
         class="glightbox preview-link">
         <i class="bi bi-zoom-in"></i>
  ...
  <div class="portfolio-content h-100">
    ...
    <div class="portfolio-info">
      <h4>App 3</h4>
      <p>Lorem ipsum, dolor sit amet consectetur</p>
      <a href="{{ asset('Frontend/assets/img/portfolio/app-3.jpg') }}" 
         title="App 1" 
         data-gallery="portfolio-gallery-app" 
         class="glightbox preview-link">
         <i class="bi bi-zoom-in"></i>
  ...
  <div class="portfolio-content h-100">
    <img src="{{ asset('Frontend/assets/img/portfolio/branding-1.jpg') }}" class="img-fluid" alt="Branding 1">
    <div class="portfolio-info">
      <h4>Branding 1</h4>
      <p>Lorem ipsum, dolor sit amet consectetur</p>
      <a href="{{ asset('Frontend/assets/img/portfolio/branding-1.jpg') }}" 
         title="Branding 1" 
...
<!-- End Portfolio Item -->
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-branding">
  <div class="portfolio-content h-100">
    <img src="{{ asset('Frontend/assets/img/portfolio/branding-2.jpg') }}" class="img-fluid" alt="Branding 1">
    <div class="portfolio-info">
      <h4>Branding 2</h4>
      <p>Lorem ipsum, dolor sit amet consectetur</p>
      <a href="{{ asset('Frontend/assets/img/portfolio/branding-2.jpg') }}" 
         title="Branding 1" 
         data-gallery="portfolio-gallery-branding" 
         class="glightbox preview-link">
         <i class="bi bi-zoom-in"></i>
...
<!-- End Portfolio Item -->
          ...
          <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-branding">
  <div class="portfolio-content h-100">
    <img src="{{ asset('Frontend/assets/img/portfolio/branding-3.jpg') }}" class="img-fluid" alt="Branding 1">
    <div class="portfolio-info">
      <h4>Branding 3</h4>
      <p>Lorem ipsum, dolor sit amet consectetur</p>
      <a href="{{ asset('Frontend/assets/img/portfolio/branding-3.jpg') }}" 
         title="Branding 1" 
         data-gallery="portfolio-gallery-branding" 
         class="glightbox preview-link">
         <i class="bi bi-zoom-in"></i>
...
<!-- End Portfolio Item -->
  ...
  <div class="portfolio-content h-100">
    <img src="{{ asset('Frontend/assets/img/portfolio/product-1.jpg') }}" class="img-fluid" alt="Product 1">
    <div class="portfolio-info">
      <h4>Product 1</h4>
      <p>Lorem ipsum, dolor sit amet consectetur</p>
      <a href="{{ asset('Frontend/assets/img/portfolio/product-1.jpg') }}" 
         title="Product 1" 
...
<!-- End Portfolio Item -->
           ...
           <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-product">
  <div class="portfolio-content h-100">
    <img src="{{ asset('Frontend/assets/img/portfolio/product-2.jpg') }}" class="img-fluid" alt="Product 1">
    <div class="portfolio-info">
      <h4>Product 2</h4>
      <p>Lorem ipsum, dolor sit amet consectetur</p>
      <a href="{{ asset('Frontend/assets/img/portfolio/product-2.jpg') }}" 
         title="Product 1" 
         data-gallery="portfolio-gallery-product" 
         class="glightbox preview-link">
         <i class="bi bi-zoom-in"></i>
...
<!-- End Portfolio Item -->
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-product">
  <div class="portfolio-content h-100">
    <img src="{{ asset('Frontend/assets/img/portfolio/product-3.jpg') }}" class="img-fluid" alt="Product 1">
    <div class="portfolio-info">
      <h4>Product 3</h4>
      <p>Lorem ipsum, dolor sit amet consectetur</p>
      <a href="{{ asset('Frontend/assets/img/portfolio/product-3.jpg') }}" 
         title="Product 1" 
         data-gallery="portfolio-gallery-product" 
         class="glightbox preview-link">
         <i class="bi bi-zoom-in"></i>
...
<!-- End Portfolio Item -->
  ...
  <div class="portfolio-content h-100">
    <img src="{{ asset('Frontend/assets/img/portfolio/books-1.jpg') }}" class="img-fluid" alt="Books 1">
    <div class="portfolio-info">
      <h4>Books 1</h4>
      <p>Lorem ipsum, dolor sit amet consectetur</p>
      <a href="{{ asset('Frontend/assets/img/portfolio/books-1.jpg') }}" 
         title="Books 1" 
...
<!-- End Portfolio Item -->
           ...
           <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-books">
  <div class="portfolio-content h-100">
    <img src="{{ asset('Frontend/assets/img/portfolio/books-2.jpg') }}" class="img-fluid" alt="Books 1">
    <div class="portfolio-info">
      <h4>Books 2</h4>
      <p>Lorem ipsum, dolor sit amet consectetur</p>
      <a href="{{ asset('Frontend/assets/img/portfolio/books-2.jpg') }}" 
         title="Books 1" 
         data-gallery="portfolio-gallery-books" 
         class="glightbox preview-link">
         <i class="bi bi-zoom-in"></i>
...
<!-- End Portfolio Item -->
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-books">
  <div class="portfolio-content h-100">
    <img src="{{ asset('Frontend/assets/img/portfolio/books-3.jpg') }}" class="img-fluid" alt="Books 1">
    <div class="portfolio-info">
      <h4>Books 3</h4>
      <p>Lorem ipsum, dolor sit amet consectetur</p>
      <a href="{{ asset('Frontend/assets/img/portfolio/books-3.jpg') }}" 
         title="Books 1" 
         data-gallery="portfolio-gallery-books" 
         class="glightbox preview-link">
         <i class="bi bi-zoom-in"></i>
      ...
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
          <div class="testimonial-item">
            ...
            <h3>Jena Karlis</h3>
            <h4>Store Owner</h4>
            <p>Enim nisi quem export duis labore cillum quae magna enim sint quorum.</p>
          </div>
        </div>
        ...
        <div class="swiper-slide">
          <div class="testimonial-item">
            ...
            <h3>Matt Brandon</h3>
            <h4>Freelancer</h4>
            <p>Fugiat enim eram quae cillum dolore dolor amet nulla culpa multos export minim.</p>
          </div>
        </div>
        ...
        <div class="swiper-slide">
          <div class="testimonial-item">
            ...
            <h3>John Larson</h3>
            <h4>Entrepreneur</h4>
            <p>Quis quorum aliqua sint quem legam fore sunt eram irure aliqua veniam tempor.</p>
          </div>
        </div>
      ...
      <div class="col-lg-3 col-md-4">
        <div class="gallery-item">
          <a href="{{ asset('Frontend/assets/img/gallery/gallery-8.jpg') }}" class="glightbox" data-gallery="images-gallery">
            <img src="{{ asset('Frontend/assets/img/gallery/gallery-8.jpg') }}" class="img-fluid" alt="">
          </a>
        </div>
      </div>
